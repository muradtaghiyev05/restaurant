    ...
    <div className='bag'>
      ...
      {cart.quantity === 0 ? (
        <div className='empty-bag-container'>
          ...
          <Link to='/menu' className='Link'><button className='continue-btn'>Almağa davam et</button></Link>
        </div>
      ) : (
      <div className='bag-container'>
        <div className='top-container'>
          <Link to='/menu' className='Link'><button className='left-btn'>Almağa davam et</button></Link>
